    ...
    <div className="min-h-screen bg-paper overflow-x-hidden selection:bg-banky-pink selection:text-ink font-sans">
      ...
      <nav className="flex items-center justify-between p-6 max-w-7xl mx-auto sticky top-0 bg-paper/90 backdrop-blur-md z-50 border-b-2 border-transparent transition-all">
        ...
        <div className="flex gap-4 items-center">
            ...
            <Link to="/register" className="bg-ink text-banky-yellow px-6 py-3 border-2 border-transparent hover:bg-banky-yellow hover:text-ink hover:border-ink hover:shadow-neo font-black transition-all font-display uppercase tracking-wider text-sm flex items-center gap-2">
              Join the Clan <ArrowRight className="w-4 h-4" />
            </Link>
        </div>
      </nav>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-12 mb-12">
                ...
                <div className="flex gap-8 md:gap-16">
                    ...
                    <div className="flex flex-col gap-4 text-center md:text-left">
                        ...
                        <a href="#" className="font-bold hover:text-banky-pink transition-colors">Privacy Policy</a>
                        <a href="#" className="font-bold hover:text-banky-pink transition-colors">Terms of Service</a>
                    </div>
                </div>
           </div>
