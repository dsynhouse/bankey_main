  ...
  return (
    <div className="space-y-8 animate-fade-in pb-20 font-sans">
       <div className="flex justify-between items-end border-b-4 border-ink pb-4">
         <div>
            <h1 className="text-5xl font-black text-ink uppercase italic tracking-tighter font-display">Wallets</h1>
            <p className="text-gray-500 font-bold mt-2">Stash your cash.</p>
         </div>
         <button onClick={() => setShowAdd(!showAdd)} className={`border-2 border-ink px-6 py-3 font-black uppercase flex items-center gap-2 shadow-neo transition-all font-display ${showAdd ? 'bg-red-500 text-white' : 'bg-banky-yellow text-ink hover:-translate-y-1'}`}>
